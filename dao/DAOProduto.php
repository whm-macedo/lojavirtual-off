...
public function cadastrar(Produto $produto){
        ...
        public function listaProduto(){
            $sql = "SELECT produto.nome, produto.preco, produto.imagem, produto.pk_produto AS 'id', categoria.nome AS 'categoria' FROM produto INNER JOIN categoria ON produto.categoria = categoria.pk_categoria";
            $con = Conexao::getInstance()->prepare($sql);
            $con->execute();
